...
if (isset($_POST['email']) && $_POST['email'] != "" ) {
    ...
    if (pg_num_rows($resultado) < 1) {
        ...
        // Inserir no banco
        $sql = "UPDATE usuario SET chave = '$chave' WHERE email = '$email';" ;
        $resultado = banco($sql);   
        ...
        $body .= "<p><a href= 'http://$_SERVER[HTTP_HOST]" . "controllers/modificar_senha.php?chave=" . $chave . "'>" . "http://$_SERVER[HTTP_HOST]" . "/voluntariojobs/modificar_senha.php?chave=" . $chave . "</a></p>";
        $body .= "</body></html>";
